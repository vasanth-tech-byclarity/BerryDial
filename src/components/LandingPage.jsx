...
//   useEffect(() => {
//     // Cleanup function to disconnect device when component unmounts
//     return () => {
//       if (device) {
//         device.destroy();
//       }
...
//     try {
//       // 1. Fetch Twilio Access Token
//       const response = await axios.get("https://15.207.173.143/twilio/token", {
//         headers: {
//           'Content-Type': 'application/json'
//         }
//       });
...
//         const activeDevice = device || await initializeTwilioDevice();
...
//           params: { 
//             To: phoneNumber,
//             From: phoneNumber // Add the From parameter
//           }
//         });
...
//           break;
//         default:
//           setCallStatus("Invalid selection.");
//       }
//     }
//   };
...
//             </span>
//             <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 mx-2 sm:mx-4 leading-relaxed">
//               Appointment | Conversation | All completely done with just a few clicks.
//             </p>
//             <div className="mt-4 sm:mt-6">
//               <button
//                 className="px-4 sm:px-6 py-2 sm:py-3 bg-black text-white text-xs sm:text-sm md:text-base font-medium rounded-md shadow-lg hover:bg-gray-800 transition-all duration-300 ease-in-out"
