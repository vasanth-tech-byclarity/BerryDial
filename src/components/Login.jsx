...
//     // Mock authentication
//     if (formData.userID === "berry" && formData.password === "password") {
//       setLoginSuccess(true);
//       setErrors({ ...newErrors, login: false });
//       // Navigate to Appointment component
//       const root = document.getElementById('root');
//       root.innerHTML = '';
//       const appointmentDiv = document.createElement('div');
//       root.appendChild(appointmentDiv);
//       createRoot(appointmentDiv).render(<Appointment />);
//     } else {
...
//         <h2 className="text-center text-2xl font-bold mb-6">Login to Demo Account</h2>
...
//           {errors.login && (
//             <p className="text-red-500 text-sm mt-3">Invalid User ID or Password.</p>
//           )}
//           {loginSuccess && (
